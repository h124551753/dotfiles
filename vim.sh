...
echo -e "\033[41;32m Step1: backing up current vim config \033[0m"
today=`date +%Y%m%d`
...
echo -e "\033[41;32m Step3: update/install plugins using Vundle \033[0m"
system_shell=$SHELL
export SHELL="/bin/sh"

echo -e "\033[41;32m install the plug.vim from github \033[0m"
...
echo -e "\033[41;32m Step4: compile YouCompleteMe \033[0m"
echo -e "\033[41;32m It will take a long time, just be patient! \033[0m"
echo -e "\033[41;32m If error,you need to compile it yourself \033[0m"
echo -e "\033[41;32m cd $CURRENT_DIR/.vim/plugged/YouCompleteMe/ && python install.py --clang-completer \033[0m"
